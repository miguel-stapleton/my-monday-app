...
export interface ModalTopActionsProps {
     ...
     */
    renderAction?: React.ReactElement<typeof MenuButton | typeof IconButton> | ((color?: ModalTopActionsButtonColor) => React.ReactElement<typeof MenuButton | typeof IconButton>);
    /**
