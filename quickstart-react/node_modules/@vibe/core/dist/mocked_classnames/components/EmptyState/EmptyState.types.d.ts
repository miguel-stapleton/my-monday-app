...
export interface EmptyStateProps extends VibeComponentProps {
    ...
    mainAction?: React.ReactElement<ButtonProps> | (Omit<ButtonProps, "kind" | "children" | "size"> & {
        kind?: Exclude<ButtonType, "tertiary">;
        text: string;
    });
    /** Supporting action (link or tertiary button) configuration */
    supportingAction?: React.ReactElement<ButtonProps | LinkProps> | (Omit<ButtonProps, "kind" | "children" | "size"> & {
        kind: "tertiary";
        text: string;
    }) | (LinkProps & {
        text: string;
