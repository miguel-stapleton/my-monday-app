...
const defaultMuaFormFields: FormField[] = [
  {
    ...
    mondayColumn: 'bride_name',
    mondayColumnType: 'text',
    helpText: "Please provide the bride's full name",
    editable: false
  },
  {
    id: 'email',
  ...
  },
  {
    ...
    mondayColumn: 'wedding_date',
    mondayColumnType: 'date',
    helpText: "Please provide your wedding date",
    editable: false
  },
  {
    id: 'beautyVenue',
    ...
    mondayColumn: 'beauty_venue',
    mondayColumnType: 'text',
    helpText: "Please provide the venue where beauty services will take place",
    editable: false
  },
  {
    id: 'description',
    ...
    mondayColumnType: 'text',
    placeholder: "Any additional information or special requests...",
    helpText: "Please provide any additional details or special requests",
    editable: false
  },
  {
    ...
    subtitle: 'Choose if you would like a hairstylist as well',
    type: 'select',
    required: true,
    enabled: true,
    invisible: false,
